...
import { AdminArrivalTimeBar } from "./AdminArrivalTimeBar";

export function AdminArrivals(props: {arrivals: Arrival[]}) {
    ...
    function renderArrivalTimeBar(day: string, time: string, isArrival: boolean) {
        ...
        return (<AdminArrivalTimeBar day={day} time={time} width={width} quantity={quantity} isArrival={isArrival} families={families}/>)
    }
