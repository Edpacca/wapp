    ...
    return (
        <div>
            <div className="song-wrapper">
                <div className="song-title" onClick={() => window.open(polishSongLink,'_blank')}>Two Hearts</div>
                <div className="song-sub">Polish Folk</div>
                <img className="wee-flag" src={polishFlag} alt="polish flag"/>
                <button className="lyric-link">Lyrics</button>
            </div>
            <div className="song-wrapper">
                <div className='song-order'>Closing song</div>
                <div className="song-title" onClick={() => window.open(scotSongLink,'_blank')}>Mairi's (Ala's) Wedding</div>
