...
export function BigDay() {
    ...
    return (
        <div>
            <img className="marker1" src={leaf} />
            <img className="marker2" src={leaf} />
            ...
            <div className="animation-panel">
                ...
                <div>
                    ...
                    <div className="ringL-wrap"><ScrollAnimation props={ringL} panel={{ index: 0, max: panelCount }} pageHeight={clientHeight}/></div>
                    <div className="ringR-wrap"><ScrollAnimation props={ringR} panel={{ index: 0, max: panelCount }} pageHeight={clientHeight}/></div>
                    <div className="heart-wrap anim-wrap"><ScrollAnimation props={heart}  panel={{ index: 1, max: panelCount }} pageHeight={clientHeight}/></div>
