...
import { Choices, selectChoices } from './foodSlice';
    ...
    return (
        <div className="menu-wrapper">
            ...
            <div className="courses-wrapper">
                ...
                <Course courseTitle={"Main Course"} course={"main"} foodItems={mains} isVegan={isVegan} isPolish={isPolish} choice={choices.main}/>
                <Course courseTitle={"Dessert"} course={"dessert"} foodItems={desserts} isVegan={isVegan} isPolish={isPolish} choice={choices.dessert}/>
